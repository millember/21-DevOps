...
* Запросить обновление ip -адреса у ws21:
    ...
    ![ws21before](./img/p6-11.png)

    После обновления:

    ![ws21after](./img/p6-12.png)
...
* Добавьте в файл еще одно правило:
    ...
    ![filewall2](./img/p7-6.png)

* Запустите файл:

    ![runagain](./img/p7-7.png)
