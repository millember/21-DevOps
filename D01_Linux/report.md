...
- С помощью команды `hostname` выясним, что при установке ОС машине было задано задано название `niyaz03`. 
...
- Как видно из скриншотов, внешний IP-адрес шлюза: 178.207.154.251; а внутренний: 10.0.2.2
...
- Команда `top` выводит на экран:
  ...
  - загрузка cpu - 0.0 %;
  - загрузка памяти - 160.6 из 1971.3;
  - pid процесса занимающего больше всего памяти - 568;
  - pid процесса, занимающего больше всего процессорного времени - 568 <br>
...
- Выполним команду:
    ...
    >Для корневого раздела (/):\
        ...
        - Размер занятого пространства: 5210948;\
        - Размер свободного пространства: 5928704;\
...
- Время последней успешной авторизации: Mar 11 09:53:20
